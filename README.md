...
## Project Description
The Gebar Commercial Bank project is building a database to improve how the bank works. This bank is a sized bank in Ethiopia. The database will help with tasks like signing up customers managing types of accounts and giving loans to people and businesses. It will also help move money between branches. The database will keep track of what's happening at each branch what transactions have taken place and how customers are being helped.
